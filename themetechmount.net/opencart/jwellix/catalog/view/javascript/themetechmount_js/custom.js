...
$(document).ready(function() {
    ...
    $('.product_carousel,.sideproduct_carousel,.producttab_carousel,.brand_carousel,.blog-carousel,#ttmtestimonial_carousel,#ttmcat_carousel,.instagram_carousel, .gallery_album_carousel, .special_product_carousel,.advertisement-wrapper').addClass('owl-carousel');
